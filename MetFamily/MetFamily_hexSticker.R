...
## Read the drawing
setwd("~/Desktop/BiocStickers/MetFamily")
img <- readPNG("./MetFamily_logo.png")
...
sticker(gg, dpi = 1440, package="", p_size = 0.1, s_x = 1.0, s_y = 1.15, s_width = 1.6,
        ...
        h_color = col_border, filename="MetFamily.png", p_family = "Aller_Lt",
        u_color = col_border, url = "msbi.ipb-halle.de/MetFamily")

set.seed(123)
sticker(gg, dpi = 1440, package="", p_size = 0.1, s_x = 1.0, s_y = 1.15, s_width = 1.6,
        s_height = 1.6, p_color = col_text, h_fill = col_bg,
        spotlight = TRUE, l_x = 1.25, l_y = 0.75, l_alpha = 0.8,
        h_color = col_border, filename="MetFamily_hl.png", p_family = "Aller_Lt",
        u_color = col_border, url = "msbi.ipb-halle.de/MetFamily")
